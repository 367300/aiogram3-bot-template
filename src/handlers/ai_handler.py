...
async def handle_message(message: types.Message):
    ...
    prompt += "Используй markdown разметку для форматирования: **жирный текст**, *курсив*, `код`, ```блоки кода```. "
    prompt += "Можешь использовать заголовки # ## ### #### - они будут автоматически конвертированы в жирный текст."
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system", 
                    "content": "Ты полезный ассистент, отвечающий на вопросы о коде и функциональности на основе предоставленной информации. Отвечай на русском языке. Используй markdown разметку для форматирования: **жирный текст**, *курсив*, `код`, ```блоки кода```. Можешь использовать заголовки # ## ### #### - они будут автоматически конвертированы в жирный текст."
                },
